...
3. **Every integration is a `source.json`.** Isolating provider behaviour behind a
   ...
   [`ENG-INT-001`](https://github.com/jrmoulckers/engineering/blob/v0.110.0/principles/platforms/integration-boundaries.md#thin-typed-adapters).
...
4. **No secrets in the tree.** Per
   [`ENG-SEC-001`](https://github.com/jrmoulckers/engineering/blob/v0.110.0/principles/assurance/security-and-privacy.md#secret-lifecycle),
