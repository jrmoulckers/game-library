...
- **Symbolic roots, relative paths.** Keeping device paths, drive letters, home
  ...
  [`ENG-SEC-001`](https://github.com/jrmoulckers/engineering/blob/v0.2.2/principles/assurance/security-and-privacy.md#secret-lifecycle).
...
- **Sanitized reports.** Redacting sensitive payloads before evidence leaves the
  ...
  [`ENG-OBS-005`](https://github.com/jrmoulckers/engineering/blob/v0.2.2/principles/operations/observability.md#redacted-observable-evidence).
